    ...
    async def _run_rewrite(self, input_data: dict) -> AgentResult:
        ...
        if language == "da":
            system = (
                ...
                "PROFILSAMMENFATNING:\n"
                "Profilteksten (## Professionel profil) MÅ IKKE indeholde målvirksomhedens navn. "
                ...
                "MASTER CV 2.0 SEKTIONER — sørg for at ALLE er til stede:\n"
                "## Professionel profil / ## Erhvervserfaring / ## Udvalgte resultater / "
                "## Kompetencer / ## Systemer / ## Uddannelse / ## Certifikater / ## Sprog\n\n"
                ...
                "- ## Udvalgte resultater: bevar kvantificerede præstationer separat fra erfaringstekst.\n"
                "- ## Systemer: IT-platforme og teknologier SKAL have sin egen sektion.\n"
                "- Uddannelse, certifikater SKAL bevares hvis de er i udkastet.\n\n"
                "AKTIVT SPROG:\n"
