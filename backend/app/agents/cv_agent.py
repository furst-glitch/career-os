    ...
    async def generate(self, input_data: dict) -> AgentResult:
        ...
        if language == "da":
            system = (
                ...
                "  - Bullet point med konkret resultat (brug tal/procenter hvis muligt)\n"
                "  - Bullet point med nøgleopgave\n\n"
                "## Kompetencer\n"
            ...
            system = (
                ...
                "  - Bullet with concrete result (use numbers/percentages where possible)\n"
                "  - Bullet with key responsibility\n\n"
                "## Skills\n"
