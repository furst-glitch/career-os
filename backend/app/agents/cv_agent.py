    ...
    async def generate(self, input_data: dict) -> AgentResult:
        ...
        if language == "da":
            system = (
                ...
                "OBLIGATORISKE SEKTIONER (altid til stede, altid udfyldt):\n"
                "1. Profilsammenfatning — 4-5 sætninger\n"
                "2. Erhvervserfaring — ALLE stillinger med kontekstlinje + bullets\n"
                "3. Uddannelse — fra profilen, aldrig 'ikke angivet'\n"
                "4. Kompetencer — minimum 10 punkter\n"
                "5. Frivilligt arbejde hvis til stede i profilen\n"
                "6. Sprog\n\n"
                ...
                "## Sprog\n"
                "Angiv alle sprog fra profilen med niveau (modersmål, flydende, arbejdsniveau).\n\n"
            ...
            system = (
                ...
                "MANDATORY SECTIONS (always present, always populated):\n"
                "1. Profile summary — 4-5 sentences\n"
                "2. Work experience — ALL positions with context line + bullets\n"
                "3. Education — from profile, never 'not provided'\n"
                "4. Skills/competencies — minimum 10 items\n"
                "5. Voluntary work if present in profile\n"
                "6. Languages\n\n"
                ...
                "## Languages\n"
                "List all languages from the profile with level (native, fluent, working level).\n\n"
