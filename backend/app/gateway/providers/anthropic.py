"""
AnthropicAdapter — wraps LiteLLM for Anthropic API calls.
...
class AnthropicAdapter(AbstractProviderAdapter):
    """
    Adapter for Anthropic Claude models via LiteLLM.

    Supported models: haiku, sonnet, opus, fable families.
    Embeddings: not supported (Anthropic does not provide embeddings API).
    """
